...
const LovCustomerOrderSelect = ({
  ...
  const { useCustomerOrderData } = useOutsourceData();
  const { data, isFetching } = useCustomerOrderData({ isGroup: true });
...
export default LovCustomerOrderSelect;
