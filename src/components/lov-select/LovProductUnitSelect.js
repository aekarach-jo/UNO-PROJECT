...
const LovProductUnitSelect = ({
  ...
  const { useLovUnitData } = useOutsourceData();
  const { data, isFetching, refetch } = useLovUnitData({ isGroup: true });
...
export default LovProductUnitSelect;
