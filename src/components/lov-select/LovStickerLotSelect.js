...
const LovStickerLotSelect = ({
  name,
  value,
  lov,
  lovLabel = 'productionOrderNo',
  lovValue = 'productionOrderId',
  isClearable,
  isDisabled,
  onChange,
  placeholder,
  ...
  const { useLovStickerLot } = useProductLovData();
  const { data, isFetching, refetch } = useLovStickerLot({ isGroup: true });
...
export default LovStickerLotSelect;
