...
const LovStockSupplier = ({
  name,
  value,
  lov,
  lovLabel = 'materialName',
  lovValue = 'materialId',
  isClearable,
  isDisabled,
  onChange,
  ...
  const { useStockSupplier } = useProductLovData();
  const { data, isFetching } = useStockSupplier({ isGroup: true });
...
export default LovStockSupplier;
