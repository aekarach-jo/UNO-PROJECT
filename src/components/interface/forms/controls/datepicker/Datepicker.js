...
const Datepicker = () => {
  ...
  const scrollspyItems = [
    { id: 'title', text: 'Title' },
    { id: 'Thai.Year', text: 'Thai Gregorian Year' },
    { id: 'basic', text: 'Basic' },
    ...
    <>
      ...
      <Row>
        <Col>
          ...
          {/* TH year Start */}
          <section className="scroll-section" id="Thai.Year">
            <h2 className="small-title">Thai Gregorian Year</h2>
            <Card body className="mb-5">
              <Row>
                <Col xs="12" lg="6">
                  <Form.Label className="d-block">Thai Calendar</Form.Label>
                  <DatepickerThaiYear />
                </Col>
              </Row>
            </Card>
