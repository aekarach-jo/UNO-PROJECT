        ...
        <div className="page-title-container mb-3">
          <Row>
            <Col className="mb-2">
              ...
              <div className="text-muted font-heading text-small">Let us manage the tasks for your company so you can focus more on your business.</div>
            </Col>
          </Row>
        </div>
        {/* Title End */}
            ...
            <Card className="sh-45 h-lg-100 position-relative bg-theme">
              ...
              <div className="card-img-overlay d-flex flex-column justify-content-end bg-transparent">
                <div className="mb-4">
                  ...
                  <div className="w-50 text-alternate">With cloud ERP, you can work more productively, any time any where, while also working smarter.</div>
                </div>
                <div>
                  <NavLink to="#" className="btn btn-icon btn-icon-start btn-primary mt-3 stretched-link">
                ...
                <Col>
                  <Card.Body className="d-flex flex-column p-0 pe-4 h-100 justify-content-center">
                    <div className="d-flex flex-column">
                      <NavLink to="/master/customer" className="stretched-link alternate-link">
                        Your Customer
                      </NavLink>
                      <div className="text-small text-muted text-truncate">Systematic manage your customer.</div>
                    </div>
                  </Card.Body>
                </Col>
              </Row>
            ...
            <Card className="mb-2 hover-border-primary">
              <Row className="g-0 sh-9">
                ...
                <Col>
                  <Card.Body className="d-flex flex-column p-0 pe-4 h-100 justify-content-center">
                    <div className="d-flex flex-column">
                      <NavLink to="/master/machine" className="stretched-link alternate-link">
                        Machinery Configuration
                      </NavLink>
                      <div className="text-small text-muted text-truncate">Make your machine configure correctly.</div>
                    </div>
                  </Card.Body>
                </Col>
              </Row>
            ...
            <Card className="mb-2 hover-border-primary">
              <Row className="g-0 sh-9">
                ...
                <Col>
                  <Card.Body className="d-flex flex-column p-0 pe-4 h-100 justify-content-center">
                    <div className="d-flex flex-column">
                      <NavLink to="/production/dailyplan" className="stretched-link alternate-link">
                        Production Plan
                      </NavLink>
                      <div className="text-small text-muted text-truncate">manage your daily plan effectivey.</div>
                    </div>
                  </Card.Body>
                </Col>
              </Row>
            ...
            <Card className="hover-border-primary">
              <Row className="g-0 sh-9">
                ...
                <Col>
                  <Card.Body className="d-flex flex-column p-0 pe-4 h-100 justify-content-center">
                    <div className="d-flex flex-column">
                      <NavLink to="/inventory/movement" className="stretched-link alternate-link">
                        Tracks your Inventory
                      </NavLink>
                      <div className="text-small text-muted text-truncate">Track stock movement rapidly.</div>
                    </div>
                  </Card.Body>
                </Col>
              </Row>
