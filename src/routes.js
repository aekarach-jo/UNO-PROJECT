...
const dashboards = {
  index: lazy(() => import('views/dashboard/Dashboards')),
...
const routesAndMenuItems = {
  mainMenuItems: [
    ...
    },
    {
      ...
      icon: 'home',
      subs: [
        { path: '/default', label: 'menu.default', component: dashboards.default, hideInMenu: true },
        { path: '/visual', label: 'menu.visual', component: dashboards.visual, hideInMenu: true },
        { path: '/analytic', label: 'menu.analytic', component: dashboards.analytic, hideInMenu: true },
      ],
    },
    {
      path: `${appRoot}/evaluation`,
      component: {},
      label: 'menu.evaluation',
      icon: 'note',
      subs: [
        { path: '/default', label: 'menu.evaluation-self', component: dashboards.default, hideInMenu: false },
        { path: '/visual', label: 'menu.evaluation-emp', component: dashboards.visual, hideInMenu: false },
        { path: '/analytic', label: 'menu.evaluation-result', component: dashboards.analytic, hideInMenu: false },
      ],
    },
    {
      ...
      icon: 'gear',
      subs: [
        { path: '/default', label: 'menu.profile', component: dashboards.default, hideInMenu: false },
      ],
    },
    // {
    //   path: `${appRoot}/apps`,
